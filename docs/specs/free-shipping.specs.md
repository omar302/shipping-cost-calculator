...
**As an online retailer, I want to waive shipping on larger domestic orders of manageable size, so that customers are encouraged to consolidate purchases into a single delivery.**

## Rules and Examples

### Rule: Must waive the shipping cost only for a domestic parcel of at most 20.00 kg whose order total reaches £75.00
...
|---|---|---|---|
| DOMESTIC | 2.00 kg | £80.00 | £0.00 |
| DOMESTIC | 20.00 kg | £80.00 | £0.00 |
| DOMESTIC | 20.01 kg | £80.00 | £9.00 |
| DOMESTIC | 2.00 kg | £75.00 | £0.00 |
| DOMESTIC | 2.00 kg | £74.99 | £4.99 |
| EUROPEAN | 2.00 kg | £100.00 | £7.49 |
| INTERNATIONAL | 2.00 kg | £1,000.00 | £12.48 |

The 20.00 kg and £75.00 rows are the boundaries — reaching either threshold still qualifies. The 20.01 kg row is a counter-example that pays in full despite an £80.00 order, and the £74.99 row a penny short of qualifying. The EUROPEAN and INTERNATIONAL rows are the point of the rule: no order total, however large, and no weight, however light, earns free shipping outside the domestic zone.
...
- **Example:** The one where a 2.00 kg DOMESTIC order of £80.00 reports a total cost of £0.00 and free shipping applied, while the breakdown still shows the £4.99 zone-adjusted rate that was waived.
- **Counter-example:** The one where a 2.00 kg EUROPEAN order of £100.00 reports a total cost of £7.49 and free shipping *not* applied — the flag is reported even when it changes nothing, as the zone multiplier already is.
...
| £75.0000 | Accepted — the same as £75.00 |
...
- **Qualifying conditions:** all three must hold — DOMESTIC zone, parcel weight at most 20.00 kg, order total at least £75.00. Both thresholds inclusive.
- **Weight cap:** 20.00 kg, which is exactly the no-surcharge range. A parcel carrying an over-20kg surcharge never qualifies.
- **Threshold:** £75.00. Fixed, not configurable or per-customer.
- **Zone restriction:** DOMESTIC only. EUROPEAN and INTERNATIONAL never qualify at any order total or weight.
